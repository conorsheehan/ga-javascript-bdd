var roadTripApp3 = (function() {
    ...
    return {
        ...
        shareTrip: function(friendName, friendEmail) {
            var self = this;
            return $.ajax({
                type: 'POST',
                url: '/api/share',
                ...
                self.displayShareErrorMessage();
            });
        },

        /** Display the success message after sharing a trip with a friend */
        displayShareSuccessMessage: function() {
            $('.share-success').show();
            return this;
        },

        /** Display the error message after failing to share a trip with a friend */
        displayShareErrorMessage: function() {
            $('.share-error').show();
            return this;
        }
